...
from flaskblog.forms import RegistrationForm, LoginForm, UpdateAccountForm, \
    PostForm, EditProfileForm, AdminUserCreateForm, AdminUserUpdateForm
...
def save_picture(form_picture):
    ...
    path = os.path.join(app.root_path,
                        'static/profile_pics/' + current_user.username)
...
def account():
    ...
    current_user_image_file = current_user.image_file.replace('\\', '/')
    image_file = url_for('static',
                         filename='profile_pics/' + current_user_image_file)
